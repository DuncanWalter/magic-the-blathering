...
public final class Demo
{
    ...
    {
        Demo stage8 = new Demo();
        JFrame frame = stage8.getUI();
        frame.pack();
    ...
    private JMenuBar getMenuBar() {
        ...
        aboutItem.addActionListener(e ->{
            ...
            try {
                editorPane = new JEditorPane(Resources.getResource("about/about.html"));

                editorPane.addHyperlinkListener(e12 -> {
                    if (e12.getEventType() == HyperlinkEvent.EventType.ACTIVATED)
                        Resources.openURLInSystemBrowser(e12.getURL());
                });
                editorPane.setEditable(false);
                window.add(new JScrollPane(editorPane), gc);
                ...
                window.add(closeButton, gc);
                window.setVisible(true);
            } catch (Exception e1) {
                e1.printStackTrace();
                JOptionPane.showMessageDialog(frame, "Error displaying About Page!");
            }
        });
